    ...
    <>
        ...
        <Modal onClose={() => setModalState(false)}>
          <div className="modal-content">
            ...
            <div className="buttons-wrapper">
              <button className="modal-button">No, Cancel</button>
              <button className="modal-button alert">Yes,delete</button>
            </div>
          </div>
        </Modal>
      ) : null}
      <div className="admin-list" id={Userid + 1}>
        ...
        <button className="admin-list-action" onClick={AdminHandelAction}>
          ...
          <div
            className={`admin-list-action-menu ${adminState ? "active" : ""}`}
          >
            <span className="admin-list-action-before">
              <svg
                width="25"
                height="20"
                viewBox="0 0 10 8"
              ...
              >
                <path
                  d="M5.411 7.40678C5.21215 7.69378 4.78784 7.69378 4.589 7.40678L0.347536 1.28475C0.117796 0.953146 0.355124 0.5 0.758534 0.5L9.24147 0.500001C9.64488 0.500001 9.8822 0.953147 9.65246 1.28475L5.411 7.40678Z"
                  fill="white"
                />
              </svg>
            </span>
            ...
            >
              <span className="admin-list-action-menu-button__icon">
                ...
                >
                  <path
                    d="M5.25 3.50003V2.00003H12.75V3.50003H16.5V5.00003H15V16.25C15 16.4489 14.921 16.6397 14.7803 16.7804C14.6397 16.921 14.4489 17 14.25 17H3.75C3.55109 17 3.36032 16.921 3.21967 16.7804C3.07902 16.6397 3 16.4489 3 16.25V5.00003H1.5V3.50003H5.25ZM4.5 5.00003V15.5H13.5V5.00003H4.5ZM6.75 7.25003H8.25V13.25H6.75V7.25003ZM9.75 7.25003H11.25V13.25H9.75V7.25003Z"
                    fill="#CB0D0D"
                  />
                </svg>
              </span>
              <span className="admin-list-action-menu-button__text delate">
                Delete
              </span>
            </Link>
          </div>
...
=======
export default AdminListItem;
>>>>>>> 5d57b50e25e37d6b0bf73cbce7d9ad259df1bcf9
